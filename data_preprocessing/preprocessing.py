...
class Preprocessor:
    ...
    def replaceInvalidValuesWithNull(self,data):
        ...
        """
            ...
            Output: Returns data with np.NAN values where there was ? or na
        """
    ...
    def encodeCategoricalValues(self,data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Successfully encoded Categorical Values from Preprocessor class')
            return data
        except Exception as e:
            self.logger_object.log(self.file_object, "Exception occured in encodeCategoricalValues method.Exception message: "+str(e))
            raise Exception()
